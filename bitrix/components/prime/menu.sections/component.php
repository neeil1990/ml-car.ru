...
foreach($arResult["SECTIONS"] as $arSection)
{
	...
	if(CModule::IncludeModule("iblock")){
		$arModel = [];
		$rsElements = CIBlockElement::GetList(Array(), ["IBLOCK_ID" => IntVal($arParams["IBLOCK_ID"]), "SECTION_ID" => $arSection["ID"], "ACTIVE"=>"Y"], false, false, ["ID", "NAME", "DETAIL_PAGE_URL"]);
		while($arElement = $rsElements->GetNext())
			$arModel[$arElement['ID']] = $arElement;
	}
